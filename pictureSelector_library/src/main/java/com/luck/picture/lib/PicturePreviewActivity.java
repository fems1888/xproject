    ...
    public void onSelectNumChange(boolean isRefresh) {
        ...
        if (enable) {
            ...
            if (numComplete) {
                ...
                tv_ok.setText(TextUtils.isEmpty(getIntent().getStringExtra(PictureConfig.DONE))?getString(R.string.picture_completed):getIntent().getStringExtra(PictureConfig.DONE));
            }
        } else {
