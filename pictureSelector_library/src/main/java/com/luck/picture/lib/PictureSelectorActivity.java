...
public class PictureSelectorActivity extends PictureBaseActivity implements View.OnClickListener,
    ...
    private void initView(Bundle savedInstanceState) {
        ...
        picture_right.setText(config.getContet()[2]);
        picture_id_preview.setText(config.getContet()[3]);
        ...
        mediaLoader = new LocalMediaLoader(this, config.mimeType, config.isGif, config.videoMaxSecond, config.videoMinSecond,config.getContet()[0]);
        rxPermissions.request(Manifest.permission.READ_EXTERNAL_STORAGE)
                .subscribe(new Observer<Boolean>() {
                    @Override
                    public void onSubscribe(Disposable d) {
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.picture_id_preview) {
            ...
            bundle.putString(PictureConfig.DONE,config.getContet()[5]);
    ...
    public void changeImageNumber(List<LocalMedia> selectImages) {
        ...
        if (enable) {
            ...
            if (numComplete) {
                ...
                picture_tv_ok.setText(config.getContet()[5]);
                anim = false;
            }
        } else {
            ...
            if (numComplete) {
                ...
                picture_tv_ok.setText(config.getContet()[4]);
            }
        }
    }
